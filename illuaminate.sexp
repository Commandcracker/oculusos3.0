...
(at /
 ...
 (lint
   ...
   (globals :max term colors write rednet fs shell os printError read bit)
...
(doc
  ...
  (site
    ...
    (source-link https://github.com/Commandcracker/oculusos3.0/blob/${commit}/${path}#L${line})
    
    ;; The full URL the site is hosted on (e.g. https://example.com/docs).
    (url "https://commandcracker.github.io/oculusos3.0")
