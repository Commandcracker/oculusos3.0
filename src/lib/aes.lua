-- aeslua
-- by SquidDev
-- based on https://github.com/bighil/aeslua
-- GNU Lesser General Public License v2.1
-- Last updated: Apr 11 2016

-- Changelog:
-- [Date]        [Author]         [Change]
-- (July 6 2022) (Commandcracker) (made every global variable local and return them in a table. to make "require('aes')" work)
