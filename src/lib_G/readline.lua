...
-- by SquidDev
-- MIT License
-- GitHub: https://github.com/SquidDev-CC/mbs/blob/c0dd46832610ec78b817184056e1b80b5c5da964/lib/readline.lua
...
local function readline(opts)
    ...
    local complete_fg = opts.complete_fg or colour_table[settings.get("mbs.readline.complete_fg")] or
        colour_table["grey"] or -1
...
function _G.read(replace_char, history, complete, default)
